...
import { DataTypes, MarketplaceItem } from './types';
...
export const assistants: DataTypes[] = [
	...
	},
	{
		...
		creator: "q2019715",
		description: "Helps you rewrite documentation, API references, and blog posts with technical clarity.",
		category: "Content",
		icon: "📝",
	...
	},
	{
		...
		creator: "shinishiho",
		description: "Summarizes podcasts, tech talks, and tutorials from YouTube into digestible notes.",
		category: "Media",
		icon: "🎙️",
...
export const plugins: DataTypes[] = [
	...
	},
	{
		...
		name: "Bing_websearch",
		creator: "FineHow",
		description: "Retrieve fast results and summaries using Bing's powerful API stack.",
		category: "Web Search",
		icon: "🔍",
	},
	{
	...
	},
	{
		...
		name: "Search1API",
		creator: "fatwang2",
		description: "Aggregated search across niche technical and business sources.",
		category: "Web Search",
		icon: "🔍",
	},
];
