...
export const homeMarketplaceItems: HomeMarketplaceItem[] = [
	{
		...
		title: "Crypto Fraud Detection Agent",
		description:
			"AI analyzes abnormal yield or token behavior via DefiLlama's `get_yields_historical` and `get_stablecoin_historical` to flag anomalies.",
		category: "Finance",
		icon: "🛡️",
		gradient: "from-emerald-500 to-emerald-700",
		date: "2025-07-08",
	...
	{
		id: "crypto-sentiment-insight",
		title: "Crypto Sentiment & News Advisor",
		description:
			"Ask about any coin and get an AI-generated analysis on whether it’s a good or bad investment using trending data from CoinGecko. Shows insights based on price movement and current market traction.",
		category: "Finance",
		icon: "📰",
	...
	},
	{
		...
		title: "Realtime Market Analyzer",
		description:
			"AI-driven live analysis of crypto and DeFi markets using CoinGecko's `get_current_price` and `compare_prices`, and DefiLlama's `get_protocol_yields_historical` for performance signals.",
		category: "Finance",
		icon: "📉",
		gradient: "from-red-500 to-red-700",
		date: "2025-07-08",
	...
	{
		id: "compare-crypto-assets",
		title: "Compare Crypto Assets",
		description:
			"Use AI to generate side-by-side analysis of assets using CoinGecko's `compare_prices` and `get_historical_price` to create insights in table format.",
		category: "Finance",
		icon: "🔍",
	...
	{
		id: "defi-protocol-explorer",
		title: "DeFi Protocol Explorer",
		description:
			"Explore DeFi protocols with AI summaries using DefiLlama’s `defillama_get_top_protocols` and `defillama_get_chain_historical_tvl` to generate TVL trends and rankings.",
		category: "Finance",
		icon: "🧬",
		gradient: "from-blue-500 to-blue-700",
		date: "2025-07-08",
	...
	},
	{
		...
		title: "Crypto Investment Advisor",
		description:
			"AI recommends coins based on historical trends via CoinGecko's `get_coin_market_chart_detailed` and live data via `get_current_price` and `get_trending_coins`.",
		category: "Finance",
		icon: "📈",
		gradient: "from-purple-500 to-purple-700",
		date: "2025-07-08",
	...
	// 	title: "Market Research Agent",
	// 	description:
	// 		"AI-powered research assistant using DefiLlama's `compare_protocols_historical` and CoinGecko's `get_price_analytics` to create visual tables or insights documents.",
	// 	category: "Finance",
	// 	icon: "📊",
	// 	gradient: "from-indigo-500 to-indigo-700",
	// 	date: "2025-07-08",
	...
	// },
	{
		id: "defi-volume-analytics",
		title: "DeFi Volume Analytics",
		description:
			"AI visualizes trading volume trends using DefiLlama's `get_dex_volume` and `get_derivatives_volume` tools to assess market momentum.",
		category: "Finance",
		icon: "📊",
	...
	// {
	// 	id: "tvl-intelligence-insight",
	// 	title: "TVL Intelligence Insight",
	// 	description:
	// 		"Track DeFi TVL changes over time across protocols and chains using DefiLlama’s `get_chain_historical_tvl` and `compare_protocols_historical`, presented in charts or reports.",
	// 	category: "Finance",
	// 	icon: "📐",
