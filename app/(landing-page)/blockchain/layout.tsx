...
export const metadata: Metadata = {
  ...
  description:
    'Discover how Maava leverages blockchain technology to enhance asset traceability, ensure IP ownership, and integrate cross-chain capabilities for AI agents and tokenized assets.',
  keywords: [
    'blockchain AI',
    'asset traceability',
  ...
  openGraph: {
    title: 'Blockchain Technology - Secure AI Asset Protection | Maava',
    description:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Maava Blockchain Technology for AI Assets',
      },
    ],
  },
  twitter: {
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              'How Maava leverages blockchain technology to enhance asset traceability, ensure IP ownership, and integrate cross-chain capabilities',
            url: 'https://chat.vercel.ai/blockchain',
            publisher: {
              '@type': 'Organization',
              name: 'Maava',
