    ...
    <Card className="h-full bg-card hover:shadow-lg dark:hover:shadow-2xl transition-all duration-300 hover:border-primary/30 group border-border flex flex-col">
      ...
      <CardContent className="pt-0 flex-1 flex flex-col">
        ...
        <div className="flex items-center justify-between gap-2 mt-auto pt-2">
          <Badge
            variant="secondary"
            className="bg-primary/10 text-primary hover:bg-primary/20 transition-colors text-xs shrink-0"
          >
            {product.category}
          </Badge>

          <motion.div
            className="text-primary text-sm font-medium opacity-70 group-hover:opacity-100 transition-opacity shrink-0"
            initial={{ opacity: 0.7 }}
