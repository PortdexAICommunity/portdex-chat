...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Join Our Developer Community - AI & Software Innovation | Maava',
    description:
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              'Join Maava developer community for AI and software innovation',
            url: 'https://chat.vercel.ai/developers',
            mainEntity: {
              '@type': 'Organization',
              name: 'Maava Developer Community',
              description:
