...
export const metadata: Metadata = {
  ...
  description:
    'Learn about Maava, the revolutionary AI-powered platform combining chatbot technology with blockchain marketplace features. Discover how we empower creators and innovators in the AI space.',
  keywords: [
    'about portdex',
  ...
  openGraph: {
    title: 'About Maava - Community-Governed AI Agent Marketplace',
    description:
      'Learn about Maava, the revolutionary platform transforming AI agents into valuable blockchain assets.',
    type: 'website',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'About Maava - AI Agent Marketplace',
      },
    ],
  },
  twitter: {
