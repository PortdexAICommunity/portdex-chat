...
const MemoizedAssistantCard = React.memo(
	({ assistant, onClick }: { assistant: Agent; onClick: () => void }) => (
		<AssistantCard assistant={assistant as any} onClick={onClick} />
	)
);
...
export default function Marketplace() {
	...
	const handleItemClick = useCallback(
		(item: Agent, type: "assistant" | "plugin") => {
							...
							>
								<div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
									...
									<div className="flex items-center gap-2">
										...
										>
											Showing {paginatedAssistants.length} of{" "}
								...
								{hasMoreItems && (
									<div className="flex justify-center mt-8">
										...
										>
											{isLoadingMore ? (
												<>
													<div className="animate-spin rounded-full size-4 border-b-2 border-purple-600 mr-2"></div>
													Loading...
												</>
											) : (
												<>
