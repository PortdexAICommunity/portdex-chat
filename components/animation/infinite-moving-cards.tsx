                ...
                <div className="flex items-center justify-between gap-3">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <span className="inline-flex size-full cursor-pointer items-center justify-center rounded-full bg-background px-3 py-1 text-sm font-medium dark:text-white text-black backdrop-blur-3xl">
                        Try Now
                      </span>
                    </button>
                  </div>
