            ...
            <div className="flex-1 min-w-0 flex flex-col h-full justify-between">
                  ...
                  <div className="relative">
                    {aiModel.icon?.startsWith('http') && !imageError ? (
                      ...
                      <Image
                        ...
                        width={48}
                        height={48}
                        className="rounded-md size-12 object-cover bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-700"
                      />
                    ) : (
              ...
              <div className="flex-1 mb-4">
                <p className="text-gray-600 dark:text-gray-300 text-sm line-clamp-3 leading-relaxed">
                  <span className="line-clamp-2">{aiModel.description}</span>
                </p>
              </div>
