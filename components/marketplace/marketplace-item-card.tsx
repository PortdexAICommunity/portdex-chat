    ...
    return (
      ...
      >
        <Card
          ...
          onClick={onClick}
        >
          <CardHeader className="pb-2 sm:pb-3 p-3 sm:p-4 lg:p-6 shrink-0">
          ...
          <CardContent className="pt-0 p-3 sm:p-4 lg:p-6 flex-1 flex flex-col">
            ...
            <div className="flex items-center justify-between gap-2 mt-auto">
              ...
              <motion.div
                className="text-purple-600 dark:text-purple-400 text-xs sm:text-sm font-medium opacity-70 group-hover:opacity-100 transition-opacity shrink-0 ml-2"
                initial={{ opacity: 0.7 }}
