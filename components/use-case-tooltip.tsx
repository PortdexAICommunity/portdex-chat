...
import { CreditCard, HelpCircle, Megaphone, MessageSquare } from 'lucide-react';
                      ...
                      >
                        ...
                        <div className="space-y-2">
                          {data.items.map((item, itemIndex) => (
                            ...
                            >
                              <div className="size-1.5 bg-purple-600 dark:bg-purple-400 rounded-full mt-2 shrink-0" />
                              <span>{item}</span>
                            </motion.div>
                          ))}
                        </div>
